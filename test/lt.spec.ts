...
describe(`lt() - @category Language`, () => {
  ...
  describe(`should perform Less Than comparison on numeric values`, () => {
    ...
    it(`(3,1) => false`, () => {
      ...
      const output: boolean = lt(input1, input2);
  ...
  describe(`should perform Less Than comparison on numerical strings`, () => {
  ...
  describe(`should perform Less Than comparison on strings on alphabetical order`, () => {
  ...
  describe(`should perform Less Than comparison on mix number/strings`, () => {
